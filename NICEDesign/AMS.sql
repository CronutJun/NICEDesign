...
DROP TABLE AMS.T_RC_INI_INF_HIS;
DROP TABLE AMS.T_RC_INI_INF;
DROP TABLE AMS.T_RC_REG_INF_HIS;
DROP TABLE AMS.T_RC_REG_INF;
DROP TABLE AMS.T_RM_FILE_HIS;
DROP TABLE AMS.T_RM_FILE;
DROP TABLE AMS.T_RM_COMMON;
DROP TABLE AMS.T_RM_MAC_ENV_HIS;
DROP TABLE AMS.T_RM_MAC_ENV;
DROP TABLE AMS.T_RM_MSG_HIS;
DROP TABLE AMS.T_RM_MSG;
DROP TABLE AMS.T_RM_TRX;
DROP TABLE AMS.T_PM_UPDS_MAC;
DROP TABLE AMS.T_PM_UPDS_SCHED;
DROP TABLE AMS.T_PM_UPDS_GRP;
DROP TABLE AMS.T_PM_MAC_STS;
DROP TABLE AMS.T_PM_PGM_VER;
DROP TABLE AMS.T_JM_TRX;
DROP TABLE AMS.T_JM_FILE;
...
DROP SEQUENCE AMS.SEQ_FILE_SEQ;
DROP SEQUENCE AMS.SEQ_MSG_SEQ;
DROP SEQUENCE AMS.SEQ_TRX_SEQ;
...
CREATE SEQUENCE AMS.SEQ_FILE_SEQ AS DECIMAL(7) INCREMENT BY 1 MINVALUE 0 MAXVALUE 9999999 START WITH 1 CYCLE;
CREATE SEQUENCE AMS.SEQ_MSG_SEQ AS DECIMAL(7) INCREMENT BY 1 MINVALUE 0 MAXVALUE 9999999 START WITH 1 CYCLE;
CREATE SEQUENCE AMS.SEQ_TRX_SEQ AS DECIMAL(7) INCREMENT BY 1 MINVALUE 0 MAXVALUE 9999999 START WITH 1 CYCLE;



/* Create Tables */

CREATE TABLE AMS.T_RM_MAC_ENV
(
...
IN OPER_AMS01
INDEX IN OPER_AMSINDEX01;

ALTER TABLE AMS.T_RM_MAC_ENV
  DATA CAPTURE NONE
  PCTFREE 0
  LOCKSIZE ROW
  APPEND OFF
...
COMMENT ON TABLE AMS.T_RM_MAC_ENV IS '기기환경';

COMMENT ON AMS.T_RM_MAC_ENV (
    ORG_CD               IS '기관코드',
    BRANCH_CD            IS '지점코드',
    MAC_NO               IS '기번',
    INSERT_UID           IS '등록자',
...
CREATE TABLE AMS.T_RM_MAC_ENV_HIS
(
  ORG_CD varchar(3) NOT NULL,
  BRANCH_CD varchar(8) NOT NULL,
  MAC_NO varchar(12) NOT NULL,
...
ALTER TABLE AMS.T_RM_MAC_ENV_HIS
  DATA CAPTURE NONE
  PCTFREE 0
  LOCKSIZE ROW
  APPEND OFF
...
COMMENT ON TABLE AMS.T_RM_MAC_ENV_HIS IS '기기환경이력';

COMMENT ON AMS.T_RM_MAC_ENV_HIS (
    ORG_CD               IS '기관코드',
    BRANCH_CD            IS '지점코드',
    MAC_NO               IS '기번',
    TRX_DATE             IS '거래일',
...
COMMENT ON TABLE AMS.T_RM_COMMON IS '공통코드';

COMMENT ON AMS.T_RM_COMMON (
    LCD         IS '대분류',
    MCD         IS '중분류',
    SCD         IS '소분류',
    INSERT_DATE IS '등록일',
...
COMMENT ON TABLE AMS.T_RM_TRX IS '거래내역';

COMMENT ON AMS.T_RM_TRX (
    TRX_DATE IS '거래일',
    TRX_NO   IS '거래번호',
    TRX_TIME IS '거래시간',
    TRX_CD   IS '거래코드',
...
COMMENT ON TABLE AMS.T_RM_MSG IS '전문원장';

COMMENT ON AMS.T_RM_MSG (
...
COMMENT ON TABLE AMS.T_RM_MSG_HIS IS '전문처리이력';

COMMENT ON AMS.T_RM_MSG_HIS (
    CREATE_DATE IS '전문생성일',
    MSG_SEQ     IS '전문순번',
    HIS_SEQ     IS '이력순번',
    CREATE_TIME IS '전문생성시간',
...
COMMENT ON TABLE AMS.T_RC_REG_INF IS '기기레지스트리정보';

COMMENT ON AMS.T_RC_REG_INF (
    ORG_CD       IS '기관코드',
    BRANCH_CD    IS '지점코드',
    MAC_NO       IS '기번',
...
COMMENT ON TABLE AMS.T_RC_INI_INF IS '기기INI정보';

COMMENT ON AMS.T_RC_INI_INF (
    ORG_CD      IS '기관코드',
    BRANCH_CD   IS '지점코드',
    MAC_NO      IS '기번',
...
CREATE TABLE AMS.T_RC_REG_INF_HIS
(
  ORG_CD varchar(3) NOT NULL,
  BRANCH_CD varchar(8) NOT NULL,
  MAC_NO varchar(12) NOT NULL,
...
ALTER TABLE AMS.T_RC_REG_INF_HIS
  DATA CAPTURE NONE
  PCTFREE 0
  LOCKSIZE ROW
  APPEND OFF
...
COMMENT ON TABLE AMS.T_RC_REG_INF_HIS IS '기기레지스트리정보변경이력';

COMMENT ON AMS.T_RC_REG_INF_HIS (
    ORG_CD       IS '기관코드',
    BRANCH_CD    IS '지점코드',
    MAC_NO       IS '기번',
    REG_BASE_KEY IS '레지스트리기본키',
...
CREATE TABLE AMS.T_RC_INI_INF_HIS
(
  ORG_CD varchar(3) NOT NULL,
  BRANCH_CD varchar(8) NOT NULL,
  MAC_NO varchar(12) NOT NULL,
...
ALTER TABLE AMS.T_RC_INI_INF_HIS
  DATA CAPTURE NONE
  PCTFREE 0
  LOCKSIZE ROW
  APPEND OFF
...
COMMENT ON TABLE AMS.T_RC_INI_INF_HIS IS '기기INI정보변경이력';

COMMENT ON AMS.T_RC_INI_INF_HIS (
    ORG_CD      IS '기관코드',
    BRANCH_CD   IS '지점코드',
    MAC_NO      IS '기번',
    INI_FILE_NM IS 'INI파일경로 및 이름',
...
COMMENT ON TABLE AMS.T_RM_FILE IS '파일관리원장';

COMMENT ON AMS.T_RM_FILE (
    CREATE_DATE IS '생성일',
    FILE_SEQ    IS '파일순번',
    INSERT_DATE IS '등록일',
    INSERT_UID  IS '등록자',
...
CREATE TABLE AMS.T_RM_FILE_HIS
(
  CREATE_DATE varchar(8) NOT NULL,
  FILE_SEQ varchar(7) NOT NULL,
  HIS_SEQ varchar(6) NOT NULL,
...
COMMENT ON TABLE AMS.T_RM_FILE_HIS IS '파일관리이력';

COMMENT ON AMS.T_RM_FILE_HIS (
     CREATE_DATE IS '생성일',
     FILE_SEQ    IS '파일순번',
     HIS_SEQ     IS '이력순번',
     INSERT_DATE IS '등록일',
...
CREATE TABLE AMS.T_PM_UPDS_GRP
(
...
COMMENT ON TABLE AMS.T_PM_UPDS_GRP IS '배포그룹관리';

COMMENT ON AMS.T_PM_UPDS_GRP (
    GRP_CD      IS '그룹코드',
    INSERT_DATE IS '등록일',
    INSERT_UID  IS '등록자',
    UPDATE_DATE IS '수정일',
...
CREATE TABLE AMS.T_PM_UPDS_MAC
(
  GRP_CD varchar(60) NOT NULL,
  MAC_NO varchar(12) NOT NULL,
  INSERT_DATE timestamp NOT NULL,
...
COMMENT ON TABLE AMS.T_PM_UPDS_MAC IS '배포기기관리';

COMMENT ON AMS.T_PM_UPDS_MAC (
    GRP_CD      IS '그룹코드',
    MAC_NO      IS '기기번호',
    INSERT_DATE IS '등록일',
    INSERT_UID  IS '등록자'
...
(
  ...
  FILE_SEQ varchar(7),
  PRIMARY KEY (MKR_CD, MODEL_CD, VER_ID)
)
IN OPER_AMS01
INDEX IN OPER_AMSINDEX01;

ALTER TABLE AMS.T_PM_PGM_VER
  DATA CAPTURE NONE
  PCTFREE 0
  LOCKSIZE ROW
  APPEND OFF
...
COMMENT ON TABLE AMS.T_PM_PGM_VER IS '프로그램버전관리';

COMMENT ON AMS.T_PM_PGM_VER (
    MKR_CD      IS '제조사코드',
    MODEL_CD    IS '기종코드',
    VER_ID      IS '버전ID',
    INSERT_DATE IS '등록일',
...
COMMENT ON TABLE AMS.T_PM_MAC_STS IS '기기별배포상태';

COMMENT ON AMS.T_PM_MAC_STS (
    MAC_NO      IS '기기번호',
    MKR_CD      IS '제조사코드',
    MODEL_CD    IS '기종코드',
    VER_ID      IS '버전ID',
...
CREATE TABLE AMS.T_PM_UPDS_SCHED
(
  GRP_CD varchar(60) NOT NULL,
  MKR_CD varchar(4) NOT NULL,
  MODEL_CD varchar(4) NOT NULL,
...
ALTER TABLE AMS.T_PM_UPDS_SCHED
  DATA CAPTURE NONE
  PCTFREE 0
  LOCKSIZE ROW
  APPEND OFF
...
COMMENT ON TABLE AMS.T_PM_UPDS_SCHED IS '배포일정관리';

COMMENT ON AMS.T_PM_UPDS_SCHED (
    GRP_CD      IS '그룹코드',
    MKR_CD      IS '제조사코드',
    MODEL_CD    IS '기종코드',
    VER_ID      IS '버전ID',
...
COMMENT ON TABLE AMS.T_JM_TRX IS '저널거래원장';

COMMENT ON AMS.T_JM_TRX (
...
(
  ...
  FILE_CL varchar(1) NOT NULL,
  ZIP_FILE_NAME varchar(80) NOT NULL,
  FILE_PATH varchar(260),
  PRIMARY KEY (MAC_TRX_DATE, ORG_CD, BRANCH_CD, MAC_NO, FILE_NAME)
)
IN OPER_AMS01
INDEX IN OPER_AMSINDEX01
LONG IN OPER_AMSLOB01
WITH RESTRICT ON DROP;

ALTER TABLE AMS.T_JM_FILE
  DATA CAPTURE NONE
  PCTFREE 0
  LOCKSIZE ROW
  APPEND OFF
...
COMMENT ON TABLE AMS.T_JM_FILE IS '저널파일관리';

COMMENT ON AMS.T_JM_FILE (
    MAC_TRX_DATE IS '기기거래일자',
    ORG_CD       IS '기관코드',
    BRANCH_CD    IS '지점코드',
    MAC_NO       IS '기번',
...
ALTER TABLE AMS.T_RM_MSG_HIS
  ...
  REFERENCES AMS.T_RM_MSG (CREATE_DATE, MSG_SEQ)
  ON UPDATE RESTRICT
  ON DELETE RESTRICT;

ALTER TABLE AMS.T_RM_MSG
  ADD FOREIGN KEY (TRX_DATE, TRX_NO)
  REFERENCES AMS.T_RM_TRX (TRX_DATE, TRX_NO)
  ON UPDATE RESTRICT
  ON DELETE RESTRICT;
...
ALTER TABLE AMS.T_RC_REG_INF
  ...
  REFERENCES AMS.T_RM_MAC_ENV (ORG_CD, BRANCH_CD, MAC_NO)
  ON UPDATE RESTRICT
  ON DELETE RESTRICT;
...
ALTER TABLE AMS.T_RC_REG_INF_HIS
  ...
  REFERENCES AMS.T_RC_REG_INF (ORG_CD, BRANCH_CD, MAC_NO, REG_BASE_KEY, REG_KEY_PATH, REG_KEY_NM)
  ON UPDATE RESTRICT
  ON DELETE RESTRICT;

ALTER TABLE AMS.T_RC_INI_INF_HIS
  ADD FOREIGN KEY (ORG_CD, BRANCH_CD, MAC_NO, INI_FILE_NM, INI_SECT_NM, INI_KEY_NM)
  REFERENCES AMS.T_RC_INI_INF (ORG_CD, BRANCH_CD, MAC_NO, INI_FILE_NM, INI_SECT_NM, INI_KEY_NM)
  ON UPDATE RESTRICT
  ON DELETE RESTRICT;
...
ALTER TABLE AMS.T_PM_PGM_VER
  ...
  REFERENCES AMS.T_RM_FILE (CREATE_DATE, FILE_SEQ)
  ON UPDATE RESTRICT
  ON DELETE RESTRICT;

ALTER TABLE AMS.T_PM_UPDS_MAC
  ADD FOREIGN KEY (GRP_CD)
  REFERENCES AMS.T_PM_UPDS_GRP (GRP_CD)
  ON UPDATE RESTRICT
  ON DELETE RESTRICT;
...
ALTER TABLE AMS.T_PM_UPDS_GRP
  ...
  REFERENCES AMS.T_PM_PGM_VER (MKR_CD, MODEL_CD, VER_ID)
  ON UPDATE RESTRICT
  ON DELETE RESTRICT;
